...
train_data = SoundTrainValidDataset(data_dir="./LibriSpeech-SI/train", type="train", aug=True, segement_length=16000*2+240)
valid_data = SoundTrainValidDataset(data_dir="./LibriSpeech-SI/train", type="valid", aug=True, segement_length=16000*2+240)
...
for epoch in range(100):
    ...
    if epoch % 3 == 0:
        s.save_parameters("./saved_model/noise/"+"/model_%04d.model"%epoch)
